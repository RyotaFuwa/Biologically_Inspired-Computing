...
def main():
    ...
    parser.add_argument('-x', dest='x', default=['Generation'], type=str, nargs=1, help='graph x axis parameter')
    parser.add_argument('-y', dest='y', default=['Loss'], type=str, nargs=1, help='graph y axis parameter')
